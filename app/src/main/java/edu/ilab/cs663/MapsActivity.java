...
import edu.ilab.cs663.edge.edgeMainActivity;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.edgebutton  = (Button) findViewById(R.id.edgeDetectButton);
        //create event handler for the object Detetor to launch DetectorActvity
        edgebutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //Launch classifier --here stupid default flowers classifier
                Intent intent = new Intent("edu.ilab.cs663.edge.edgeMainActivity");
                startActivity(intent);
            }
        });
