...
public class edgeMainActivity extends AppCompatActivity implements CvCameraViewListener2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!OpenCVLoader.initDebug()) {
            Toast.makeText(edgeMainActivity.this, "Unable to load OpenCV", Toast.LENGTH_LONG).show();
        }
...
import org.opencv.core.Mat;
import org.opencv.imgproc.Imgproc;
import edu.ilab.cs663.edge.CameraActivity;
import edu.ilab.cs663.R;
 ...
 * objects.
 */
public class edgeMainActivity extends CameraActivity implements OnImageAvailableListener {
...
//                            }
    ...
    private void processImage(Canvas canvas) {
      ...
      /* Mat edges = new Mat(rgba.size(), CvType.CV_8UC1);
        ...
        Imgproc.Sobel(edges, edges, -1, 1, 1);
        Core.convertScaleAbs(edges, edges, 10, 0);
        //Imgproc.cvtColor(edges, rgba, Imgproc.COLOR_GRAY2BGRA, 4);
        //Imgproc.Canny(edges, edges, 80, 100);
       //BitmapHelper.showBitmap(this, bitmap, imageView);
      //  bmp32 = Bitmap.createBitmap(edges.cols(), edges.rows(), Bitmap.Config.ARGB_8888);
       Utils.matToBitmap(edges, bmp32);*/
        //imageView.setImageBitmap(bmp32);
        //BitmapHelper.showBitmap(this, bmp32, detectEdgesImageView);
        Mat grayMat = new Mat();
